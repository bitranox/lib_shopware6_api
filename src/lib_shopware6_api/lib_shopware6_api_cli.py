...
from lib_shopware6_api_base import ConfigurationError, ShopwareAPIError
...
def _get_exit_code(exc: BaseException) -> int:
    ...
    Custom exceptions get specific exit codes; standard exceptions are delegated
    to lib_cli_exit_tools.
    """
