...
long_description = "use the shopware 6 api"
...
setup_kwargs["name"] = "lib_shopware6_api"
setup_kwargs["version"] = "v2.0.2.3"
setup_kwargs["url"] = "https://github.com/bitranox/lib_shopware6_api"
setup_kwargs["packages"] = find_packages()
setup_kwargs["package_data"] = {"lib_shopware6_api": ["py.typed", "*.pyi", "__init__.pyi"]}
setup_kwargs["description"] = "use the shopware 6 api"
...
setup_kwargs["entry_points"] = {"console_scripts": ["lib_shopware6_api = lib_shopware6_api.lib_shopware6_api_cli:cli_main"]}
